...
```js
GET https://api.narutodb.xyz/character
```
...
```js
https://api.narutodb.xyz/character?page=1&limit=20
```
  ...
  "characters": [
    {
      ...
      "name": "Abiru",
      "images": [
        "https://static.wikia.nocookie.net/naruto/images/7/72/Abiru_new.png/revision/latest/scale-to-width-down/300?cb=20220224034653"
      ],
      "debut": {
      ...
      "voiceActors": {
        "english": "Dave Wittenberg   (Part I)" .... ]

  "currentPage": "2",
  "pageSize": "7",
  "totalCharacters": 1431
}
```
