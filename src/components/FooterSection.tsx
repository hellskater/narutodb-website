...
<svg fill={resolvedTheme === 'light' ? '#000000' : '#FFFFFF'}  width="50px" height="50px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M256,48,496,464H16Z"/></svg>
    ...
    color: resolvedTheme === 'light' ? '#000000' : '#FFFFFF'
        ...
        <div className="flex gap-2 items-center">
         <svg height="45" viewBox="0 0 70 70" fill={resolvedTheme === 'light' ? '#000000' : '#FFFFFF'} xmlns="http://www.w3.org/2000/svg">
