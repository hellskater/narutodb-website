...
export default function MultiActionAreaCard(props) {
  ...
  const getResolvedImageUrl = () => {
    ...
    if (get(characterData, ["images", 0], "").includes(".png")) {
      imageURL = `${
        get(characterData, ["images", 0], "").split(".png")[0]
      }.png`;
      return imageURL;
    } else if (get(characterData, ["images", 0], "").includes(".jpg")) {
      imageURL = `${
        get(characterData, ["images", 0], "").split(".jpg")[0]
      }.jpg`;
      return imageURL;
    }
    return false;
  ...
  return (
    <Card
      sx={{ maxWidth: 450, minWidth: 330, fontFamily: "Naruto" }}
      elevation={4}
    >
      <CardActionArea
        onClick={() =>
